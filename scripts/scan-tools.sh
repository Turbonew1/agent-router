...
OUTPUT_FILE="${RULES_DIR}/agent-router.md"
...
# Agent Router — Auto-Generated Routing Rules
# Generated by: agent-router skill
# Re-run: bash ~/.claude/skills/agent-router/scripts/scan-tools.sh
...
log "To re-run: bash ~/.claude/skills/agent-router/scripts/scan-tools.sh"
