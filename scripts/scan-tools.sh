...
OUTPUT_FILE="${RULES_DIR}/claude-router.md"
...
# Claude Router — Auto-Generated Routing Rules
# Generated by: claude-router skill
# Re-run: bash ~/.claude/skills/claude-router/scripts/scan-tools.sh
...
log "To re-run: bash ~/.claude/skills/claude-router/scripts/scan-tools.sh"
